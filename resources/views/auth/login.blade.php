...
<html lang="en-US">
   <head>
      ...
      <title>Risnagrota Admin Login</title>
               ...
               <div class="row">
                  <div class="col-md-4 left-colum-for-instragram-growth">
                     <div class="main-div-for-intragram-image">
                        <img src="{{ url('public/admin/images/login.png') }}" alt="instagram-logo">
                     </div>
                  </div>
                  <div class="col-md-8 right-colum-for-instragram-growth">
                     ...
                     <div class="instragram-growth-form-div-2 top">
                        <div class="right">
                           ...
                           <!-- <p class="text-center">
                                Don't have any account? <a href="{{ route('register') }}">Create an account here</a>
                            </p> -->
                        </div>
                     </div>
                  </div>
