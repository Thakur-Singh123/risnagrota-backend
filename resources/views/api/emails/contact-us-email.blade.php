...
<html>
                ...
                <table width="600" cellpadding="0" cellspacing="0" border="0" style="background-color: #ffffff; border-radius: 15px; padding: 0; box-shadow: 0 8px 16px rgba(0, 0, 0, 0.1);">
                    ...
                    <tr>
                        <td style="padding: 30px 20px; text-align: center; color: #4a4a4a;">
                            <h2 style="font-size: 20px; font-weight: bold; margin-bottom: 10px;">Contact Us  Enquiry</h2>
                        </td>
                    </tr>
                    <!-- Details Section -->
                    <tr>
                        <td style="padding: 20px;">
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="font-size: 16px; color: #4a4a4a; line-height: 1.8;">
                                ...
                                <tr>
                                    <td style="font-weight: 800 !important; padding: 10px 0;  #eaeaea;">Massage:</td>
 ...
 <!-- <h1>Contact Us Enquiry</h1>
      <p>Full Name:- {{ $send_email['name'] }}</p>
      <p>Email:- {{ $send_email['email'] }}</p>
      <p>Phone Number:- {{ $send_email['phone_no'] }}</p>
      <p>Message:- {{ $send_email['message'] }}</p>-->
