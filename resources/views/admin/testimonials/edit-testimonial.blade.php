      ...
      <form action ="{{ route('admin.testimonial.update', $testimonial->id) }}" method = "post" enctype="multipart/form-data">
         ...
         <div class="card-body">
            ...
            <div class="form-group">
               ...
               <input type="text" name="desc" value="{{ $testimonial->desc }}" class="form-control" placeholder="Enter Description">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
               ...
               <select id="status" name="status" class="form-control" >
                  ...
                  <option value="Suspend" @if($testimonial->status == 'Suspend') selected @endif>Suspend</option>
